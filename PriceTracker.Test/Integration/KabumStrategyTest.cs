...
namespace PriceTracker.Test.Integration
{
    ...
    public class KabumStrategyTest
    {
        ...
        [Test]
        public async Task ExtractPrice_ShouldExtractCreditCardPrice()
        {
            // Arrange
            string url = "https://www.kabum.com.br/produto/426262/processador-amd-ryzen-7-7800x3d-5-0ghz-max-turbo-cache-104mb-am5-8-nucleos-video-integrado-100-100000910wof";
            ...
            // Assert
            result.ShouldNotBeNull();
            result.CreditCardPrice.ShouldNotBeNull();
            result.CreditCardInstallment.ShouldNotBeNull();
            result.CreditCardInstallment?.ShouldBe(10);
